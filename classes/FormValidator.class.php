...
class FormValidator
{
    ...
    {
    if($ruleValue['min']<$ruleValue['max']) { if($this->data[$field] < $ruleValue['min']) { $this->_flag=false;
            if(isset($this->labels[$field]))
            {
            ...
            if($this->data[$field] < $this->data[$ruleValue["compareto"]] )
                ...
                if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
                {
                $this->_errors[$field]=$this->labels[$field] . "should be greater than or equal to
                ".$this->labels[$ruleValue["compareto"]];
                }
                else if(isset($this->labels[$field]))
                {
                $this->_errors[$field]=$this->labels[$field] . "should be greater than or equal to
                ...
                {
                $this->_errors[$field]=$field. "should be greater than or equal to
                ".$this->labels[$ruleValue["compareto"]];
                }
                else
                {
                ...
                break;
                ...
                else if($ruleValue["operator"] == "<=") { if($this->data[$field] > $this->data[$ruleValue["compareto"]]
                    )
                    {
                    $this->_flag=false;
                    if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
                    {
                    $this->_errors[$field]=$this->labels[$field] . "should be less than or equal
                    to".$this->labels[$ruleValue["compareto"]];
                    }
                    else if(isset($this->labels[$field]))
                    {
                    $this->_errors[$field]=$this->labels[$field] . "should be less than or equal
                    to".$ruleValue["compareto"];
                    }
                    else if(isset($this->labels[$ruleValue["compareto"]]))
                    {
                    $this->_errors[$field]=$field. "should be less than or equal to
                    ".$this->labels[$ruleValue["compareto"]];
                    }
                    else
                    {
                    ...
                    break;
                    ...
                    else if($ruleValue["operator"] == "<") { if($this->data[$field] >=
                        $this->data[$ruleValue["compareto"]] )
                        {
                        $this->_flag=false;
                        if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
                        {
                        $this->_errors[$field]=$this->labels[$field] . "should be less
                        than".$this->labels[$ruleValue["compareto"]];
                        }
                        else if(isset($this->labels[$field]))
                        {
                        ...
                        if($this->data[$field] <= $this->data[$ruleValue["compareto"]] )
                            ...
                            if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
                            {
                            $this->_errors[$field]=$this->labels[$field] . "should be greater
                            than".$this->labels[$ruleValue["compareto"]];
                            }
                            else if(isset($this->labels[$field]))
                            {
                            $this->_errors[$field]=$this->labels[$field] . "should be greater
                            than".$ruleValue["compareto"];
                            }
                            else if(isset($this->labels[$ruleValue["compareto"]]))
                            {
                            $this->_errors[$field]=$field. "should be greater than
                            ".$this->labels[$ruleValue["compareto"]];
                            }
                            else
                            {
                            ...
                            if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
                            {
                            $this->_errors[$field]=$this->labels[$field] . "should not be equal to
                            ".$this->labels[$ruleValue["compareto"]];
                            }
                            else if(isset($this->labels[$field]))
                            {
                            ...
                            {
                            $this->_errors[$field]=$field. "should not be equal to
                            ".$this->labels[$ruleValue["compareto"]];
                            }
                            else
                            {
                            ...
                            if(isset($this->labels[$field]))
                            {
                            $this->_errors[$field]=$ruleValue["compareto"]." is required to compare with
                            ".$this->labels[$field];
                            }
                            else
                            {
